      ...
      <section id="header">
        <div className="my-custom-font flex w-screen h-[600px] items-center justify-evenly bg-[url('/assets/header2.jpg')] saturate-100 bg-cover bg-center px-2 md:px-20">
            <div className="md:pr-10">
                <div className="text-6xl text-black capitalize">Cristis Bakery</div>
                <div className="text-4xl text-black p-5">Savor the Celebration with Cristis Bakery: Crafting Special Bocadillos for Party Tables.</div>
